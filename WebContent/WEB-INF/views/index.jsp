				...
				<div class="col-12">
					<div class="product-info">
						<div class="nav-main">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item"><a class="nav-link active"
									data-toggle="tab" href="#All" role="tab">Tất cả</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#Chuột" role="tab">Chuột</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#Banphim" role="tab">Bàn phím</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#Loa" role="tab">Loa</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#Tainghe" role="tab">Tai nghe</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#Lotchuot" role="tab">Lót chuột</a></li>
						...
						<div class="tab-content" id="myTabContent">
							...
							<!-- Start Single Tab -->
							<div class="tab-pane fade" id="Chuột" role="tabpanel">
								<div class="tab-single">
									<div class="row">
										<c:forEach items="${list}" var="s">
											<c:if test="${s.type == 'Chuột' }">
												<div class="col-xl-3 col-lg-4 col-md-4 col-12">
													<div class="single-product">
														<div class="product-img">
															<a data-toggle="modal" data-target="#${s.id}"
																title="Quick View" href="#"> <img
																class="default-img"
																src="<c:choose> <c:when test= "${s.image != null}"> <c:url value="/public/images/${s.image}"> </c:url></c:when> <c:otherwise><c:url value="/public/images/noimage.png"> </c:url> </c:otherwise></c:choose>"
																"
															alt="#"> <img class="hover-img"
							...
							<!--/ End Single Tab -->
							<!-- Start Single Tab -->
							<div class="tab-pane fade" id="Lotchuot" role="tabpanel">
								<div class="tab-single">
									<div class="row">
										<c:forEach items="${list}" var="s">
											<c:if test="${s.type == 'Lót chuột' }">
												<div class="col-xl-3 col-lg-4 col-md-4 col-12">
													<div class="single-product">
														<div class="product-img">
															<a data-toggle="modal" data-target="#${s.id}"
					...
					<div class="modal-body">
						<div class="row no-gutters">
							...
							<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12"
								<c:if test= "${s.image == null}"> style="display:none;" </c:if>>
								<!-- Product Slider -->
							...
							<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12"
								<c:if test= "${s.image == null}"> style="margin:auto" </c:if>>

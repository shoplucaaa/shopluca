											...
											<div class="single-product">
												<div class="product-img">
													<a data-toggle="modal" data-target="#Modal1"
														...
														class="new">New</span> <!-- <span class="price-dec">30% Off</span> <span class="out-of-stock">Hot</span> -->
													</a>
												</div>
												<div class="product-content">
													<h3>
														<a data-toggle="modal" data-target="#Modal1"
															title="Quick View" href="#">Women Pant Collectons</a>
													</h3>
													<div class="product-price">
														<span>$29.00</span>
													</div>
											...
											<div class="single-product">
												<div class="product-img">
													<a data-toggle="modal" data-target="#Modal1"
														...
														class="hover-img"
														src="https://via.placeholder.com/550x750" alt="#"> <span
														class="out-of-stock">Hot</span> <!-- <span class="price-dec">30% Off</span> <span class="out-of-stock">Hot</span> -->
													</a>
													<div class="button-head">

														<div class="product-action-2">
															<a title="Add to cart" data-toggle="modal"
																data-target="#Modal1" title="Quick View" href="#">Click
																for more info</a>
														</div>
													</div>
												</div>

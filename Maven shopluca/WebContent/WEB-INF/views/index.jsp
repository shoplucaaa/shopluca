									...
									<div class="tab-single">
										...
										<c:forEach items="${list}" var="s">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.html">${s.name}</a></h3>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a data-toggle="modal" data-target="#Modal1" title="Quick View" href="#">
															<img class="default-img" src="https://via.placeholder.com/550x750" alt="#">
															<img class="hover-img" src="https://via.placeholder.com/550x750" alt="#">
															<span class="new">New</span> <!-- <span class="price-dec">30% Off</span> <span class="out-of-stock">Hot</span> -->
														</a>
													</div>
													<div class="product-content">
														<h3><a data-toggle="modal" data-target="#Modal1" title="Quick View" href="#">Women Pant Collectons</a></h3>
														<div class="product-price">
															<span>$29.00</span>
														</div>
													</div>
